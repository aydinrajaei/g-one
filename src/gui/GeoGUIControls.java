 ...
 *
 */
public class GeoGUIControls extends JPanel implements ActionListener, ChangeListener {
	...
	public GeoGUIControls(GeoDTNSimGUI gui, GeoPlayField pf) {
