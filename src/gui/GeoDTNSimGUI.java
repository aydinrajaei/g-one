...
import gui.playfield.GeoPlayField;
 ...
 */
public class GeoDTNSimGUI extends GeoDTNSimUI {
	private GeoMainWindow main;
	private GeoPlayField field;
	private GeoGUIControls guiControls;
	private GeoEventLogPanel eventLogPanel;
	private GeoInfoPanel infoPanel;
	...
	private void initGUI() {	
		this.field = new GeoPlayField(world, this);
		
		this.field.addMouseListener(new PlayfieldMouseHandler());
		this.field.addMouseWheelListener(new PlayfieldMouseHandler());
		
		this.guiControls = new GeoGUIControls(this,this.field);
		this.eventLogPanel = new GeoEventLogPanel(this);
		this.infoPanel = new GeoInfoPanel(this);
		this.main = new GeoMainWindow(this.scen.getName(), world, field, 
				guiControls, infoPanel, eventLogPanel, this);
		
		scen.addMessageListener(eventLogPanel);
		scen.addGeoMessageListener(eventLogPanel);
		...
		if (scen.getCast() != null ) { 
			field.setCast(scen.getCast());
		}
     ...
     */
    public GeoInfoPanel getInfoPanel() {
     ...
     */
    public GeoMainWindow getParentFrame() {
    	return this.main;
    }
