 ...
 * in the window.
 */
public class GeoMainWindow extends JFrame {
    ...
    public GeoMainWindow(String scenName, GeoWorld world, GeoPlayField field,
    		GeoGUIControls guiControls, GeoInfoPanel infoPanel,
    		GeoEventLogPanel elp, GeoDTNSimGUI gui) {    	
        ...
        GeoNodeChooser chooser = new GeoNodeChooser(world.getHosts(),gui);
        
    	setLayout(new BorderLayout());
        setJMenuBar(new GeoSimMenuBar(field, chooser));
