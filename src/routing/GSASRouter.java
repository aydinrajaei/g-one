 ...
 *
 */
public class GSASRouter extends GeoActiveRouter {
	 ...
	 */
	protected GSASRouter(GSASRouter r) {
		super(r);
	...
	@Override
	public GSASRouter replicate() {
		return new GSASRouter(this);
	}
}
