 ...
 *
 */
public class GSWDRouter extends GeoActiveRouter {
	 ...
	 */
	protected GSWDRouter(GSWDRouter r) {
		super(r);
	...
	@Override
	public GSWDRouter replicate() {
		return new GSWDRouter(this);
	}
}
