...
public class World {
	...
	protected List<? extends DTNHost> hosts; //#changed private list<DTNHost> to protected list<? extends DTNHost>
	 ...
	 * Constructor.
	 */
	public World(List<? extends DTNHost> hosts, int sizeX, int sizeY, //#changed list<DTNHost> to list<? extends DTNHost>
	 ...
	 */
	public List<? extends DTNHost> getHosts() {
		return this.hosts;
	}
